...
import com.pia.cicd.domain.Task;
import com.pia.cicd.repository.TaskRepository;
import com.pia.cicd.service.TaskService;
...
/**
 * REST controller for managing {@link com.pia.cicd.domain.Task}.
 */
@RestController
@RequestMapping("/api")
